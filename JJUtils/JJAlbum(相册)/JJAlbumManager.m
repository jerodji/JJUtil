...
#pragma mark -  JJAlbumManager

@interface JJAlbumManager()

@end

@implementation JJAlbumManager

static JJAlbumManager *sharePhotoTool = nil;
...
{
    NSMutableArray<AlbumModel *> *photoAblumList = [NSMutableArray array];
    ...
    [smartAlbums enumerateObjectsUsingBlock:^(PHAssetCollection * _Nonnull collection, NSUInteger idx, BOOL *stop) {
        ...
        if (!([collection.localizedTitle isEqualToString:@"Recently Deleted"] ||
            ...
            if (assets.count > 0) {
                AlbumModel *ablum = [[AlbumModel alloc] init];
