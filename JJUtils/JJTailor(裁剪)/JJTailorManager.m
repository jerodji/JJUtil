...
////rect是相对于view的rect
//- (UIImage*)tailorImage:(UIImage*)orImage rect:(CGRect)rect {
//    UIGraphicsBeginImageContextWithOptions(orImage.size, NO, 0);// 开启位图上下文
//    // 设置裁剪区域
...
//- (UIImage*)tailorImageWithRect:(CGRect)rect view:(UIView*)view
//{
//////    CGRect drawRect = CGRectMake(-rect.origin.x , -rect.origin.y, view.bounds.size.width , view.bounds.size.height );
////    
////    UIGraphicsBeginImageContext(rect.size);
////    
////    CGContextRef context = UIGraphicsGetCurrentContext();
////    CGContextClearRect(context, CGRectMake(rect.origin.x, rect.origin.y, rect.size.width, rect.size.height));
////    
//////    [view.layer drawInRect:drawRect];
...
- (UIImage*)tailorImage:(UIImage*)origImg rect:(CGRect)rect
{
    ...
    UIGraphicsBeginImageContext(rect.size);
    CGContextRef context = UIGraphicsGetCurrentContext();
    CGContextClearRect(context, rect); //CGRectMake(0, 0, rect.size.width, rect.size.height)
...
//- (UIImage*)tailorImage:(UIImage *)orimg rectangleRect:(CGRect)rect
//{
//    CGSize size = orimg.size;
//    UIGraphicsBeginImageContextWithOptions(size, NO, 0);
//    
//    UIBezierPath * path = [UIBezierPath bezierPathWithRect:rect]; //创建路径
//    [path addClip]; //设置为裁剪区域
//    
//    [orimg drawInRect:rect];
//    
...
//    CGSize size = cropRect.size; //返回裁剪区域图片
